...
$TextColor = IniRead($SkinPath & $Config & "\colors.inc", "Variables", "TextColor", "0x00FF00")
$BackgroundColor = IniRead($SkinPath & $Config & "\colors.inc", "Variables", "BackgroundColor", "0x000000")
$BackgroundColor2 = IniRead($SkinPath & $Config & "\colors.inc", "Variables", "BackgroundColor2", "0x292929")
...
$Edit1 = GUICtrlCreateEdit("Omnimo [Version 5.0.0001] miniCMD ", 0, 0, ($Size * 2 + 10), ($Size / 15 * 13), BitOR($WS_EX_TOOLWINDOW, $ES_READONLY, $ES_AUTOVSCROLL, $ES_AUTOHSCROLL))
GUICtrlSetColor(-1, $TextColor)
GUICtrlSetStyle(-1, $WS_EX_TOOLWINDOW, $WS_EX_TRANSPARENT)
GUICtrlSetBkColor(-1, $BackgroundColor)
GUICtrlSetFont(-1, 8, 500, 0, "Segoe UI")
