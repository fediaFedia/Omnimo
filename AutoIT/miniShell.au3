...
#AutoIt3Wrapper_Res_Description=Omnimo miniShell
...
$Size = IniRead($ConfigPath & "\size.inc", "Variables", "Height", "150")
$TextColor = IniRead($ConfigPath & "\colors.inc", "Variables", "TextColor", "0x00FF00")
$BackgroundColor = IniRead($ConfigPath & "\colors.inc", "Variables", "BackgroundColor", "0x000000")
$BackgroundColor2 = IniRead($ConfigPath & "\colors.inc", "Variables", "BackgroundColor2", "0x292929")

; Create GUI
$hGUI = GUICreate("Notes", ($Size * 2 + 10), $Size, $XPosition + 5, $YPosition + 5, BitOR($WS_VISIBLE, $WS_EX_TRANSPARENT, $WS_BORDER, $WS_POPUP), $WS_EX_TOOLWINDOW)
GUISetBkColor(0x292929)

$Output = GUICtrlCreateEdit("Omnimo [Version 5.0.0001] miniCMD ", 0, 0, ($Size * 2 + 10), ($Size / 15 * 13), BitOR($WS_EX_TOOLWINDOW, $ES_READONLY, $ES_AUTOVSCROLL, $ES_AUTOHSCROLL), $WS_EX_TRANSPARENT)
GUICtrlSetColor(-1, $TextColor)
GUICtrlSetBkColor(-1, $BackgroundColor)
GUICtrlSetFont(-1, 8, 500, 0, $font)

$Input = GUICtrlCreateInput("", 0, ($Size / 15 * 13), ($Size * 2 - 10), 20, BitOR($WS_EX_TOOLWINDOW, $ES_AUTOHSCROLL), $WS_EX_TRANSPARENT)
GUICtrlSetColor(-1, 0xffffff)
GUICtrlSetBkColor(-1, $BackgroundColor2)
GUICtrlSetFont(-1, 10, 400, 0, $font)
GUICtrlSetState(-1, $GUI_FOCUS)

$Closed = GUICtrlCreatePic("close.jpg", ($Size * 2 - 10), ($Size  - 20) , 20, 20)
